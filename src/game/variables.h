...
MACRO_CONFIG_INT(SvMaxVotetime, sv_max_votetime, 10, 5, 1000, CFGFLAG_SERVER, "If sv_restrict_votes set: The max time in minutes a mapchange or mode-change is possible")
